  ...
  """
    ...
    """
        ...
        with tf.variable_scope(scope,
            ...
            self.sequence_output = tf.cast(self.all_encoder_layers[-1],
                                           tf.float32)
...
def attention_layer(from_tensor,
  ...
  """
    ...
    #   return query
    # calc_query = tf.contrib.layers.recompute_grad(calc_query)
    # query_layer = calc_query(from_tensor_2d)
    ...
    # calc_key = tf.contrib.layers.recompute_grad(calc_key)
    # key_layer = calc_key(to_tensor_2d)

    # calc_value = tf.contrib.layers.recompute_grad(calc_value)
    # value_layer = calc_value(to_tensor_2d)
  ...
  """
    ...
    for layer_idx in range(num_hidden_layers):
        with tf.variable_scope("layer_%d" % layer_idx):
            ...
            # def intermediate_layer(input_data):
            #   with tf.variable_scope("intermediate"):
            #     intermediate_output = tf.layers.dense(
            #         input_data,
            #         intermediate_size,
            ...
            # intermediate_layer = tf.contrib.layers.recompute_grad(intermediate_layer)
